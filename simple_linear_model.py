  ...
  for repeat in range(2000):
    ...
    for train_index, test_index in fold_valid.split(sequence_pam_per_gene_grna):
      ...
      if repeat == 1999 and fold == 2:
        to_plot = True
      r2_score_score = perform_logistic_regression(sequence_pam_per_gene_grna, count_insertions_gene_grna, count_deletions_gene_grna, train_index, test_index, ins_coeff, del_coeff, to_plot)
